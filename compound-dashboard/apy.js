...
const provider = "Infura API URL here";
...
//Backend code, there was a specific way/folder, check Max course again later.
//Still need a bit more work with handling sensitive info on backend code, maybe even gitignore.
